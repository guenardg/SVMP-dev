...
void dist_geo_hvs(double* from, double* to, int* n, int* tri,   // Inputs
                  double* d,                                    // Outputs
                  double* r) {                                  // Parameters
...
void dist_geo_vif(double* from, double* to, int* n, int* tri,      // Inputs
                  double* d, int* niter,                           // Outputs
  ...
  double cos2_alpha, sin_alpha, alpha;

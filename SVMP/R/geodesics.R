...
#' 
#' Function \code{geodesics} carries out the calculation of pariwise geodesic
...
#' 
#' @return A \code{\link{dist}-class} object of a \code{\link{matrix}}.
#' 
...
#' 
#' Vincenty's inverse formula is more precise (on the order of 0.5mm) on planet
#' Earth than the haversine formula, but they involve more computation time and
...
#' were necessary to acheive convergence. Numbers greater than argument
